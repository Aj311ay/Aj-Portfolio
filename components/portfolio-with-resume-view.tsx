...
export function PortfolioWithResumeViewComponent() {
  const [showResume, setShowResume] = useState(false)

  const projects = [
    { id: 1, title: 'Pupil.com (Stackoverflow clone)', description: 'This project is a question and answering website for students and others, where the users can create there own account and they can post there questions and get the answers from other users.',tech:'MERN stack(MongoDB,Express.js,React.js,Node.js)', color: 'from-pink-600 to-rose-600' },
    { id: 2, title: 'Web Chat', description: 'Web Chat is a real-time multi user web chat application that allows users to communicate with otherin real-time. It establishes  communication between the users',tech:'React.js,Node.js,ChatEngine.io', color: 'from-purple-600 to-indigo-600' },
    { id: 3, title: 'Portfolio', description: 'A personalized portfolio designed to showcase my skills and expertise, featuring a Lets Connect section for easy communication.',tech:'Next.js,Fromspree', color: 'from-blue-600 to-cyan-600' }
  ]
  ...
  const skills = {
    ...
    tools: ['VS Code', 'Android Studio', 'Git', 'GitHub','CodeBlocks','Vercel'],
    interface:['HTML','CSS'],
    framework:['React.js','Node.js','Next.js'],
    other:['Communication','Leadership','Programming','Web Development']
  }
        ...
        <header className="text-center mb-12 py-8 bg-gray-800 rounded-2xl shadow-xl overflow-hidden relative">
          ...
          <div className="relative z-10">
            <Avatar className="w-40 h-40 mx-auto mb-6 border-4 border-purple-500 shadow-lg">
              <AvatarImage src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_20240717_203652_747-ab1zpXnXgx8Q0yc34RxwknOaCLVyPG.jpg" alt="Ajay" />
              <AvatarFallback>YN</AvatarFallback>
            </Avatar>
            <h1 className="text-5xl font-bold text-white mb-2">Ajay</h1>
            <p className="text-2xl text-purple-300 mb-6">MCA</p>
            <p className="text-2xl text-purple-300 mb-6">NMAM Institute of Technology</p>
            <div className="flex justify-center mb-4">
            <p className="text-3xl font-bold text-white glow-text typing-effect">
                Full Stack Developer
           </p>
          </div>
            <p className="text-lg text-purple-400 mb-6">Building modern web applications with passion!</p>
            <div className="flex justify-center space-x-4">
              <a 
                href="mailto:ajayias311@gmail.com" 
              ...
              <a 
                href="https://www.linkedin.com/in/ajay-aj-75284a238" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-blue-400 hover:text-blue-300 transition-colors p-2 rounded-full hover:bg-blue-900"
                aria-label="LinkedIn"
  ...
  {showResume && (
    <div className="mt-8">
      <iframe 
        src="./ResumeGeeks.pdf" 
        title="Resume" 
        className="w-full h-[600px] border border-gray-600" 
        allowFullScreen
      ></iframe>
    </div>
  )}
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="bg-gray-800 text-white overflow-hidden transform transition-all hover:scale-105 hover:shadow-2xl">
              <div className="h-2 bg-gradient-to-r from-orange-600 to-rose-600"></div>
              <CardHeader>
                <CardTitle className="text-2xl font-bold">Interface</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="list-disc list-inside">
                  {skills.interface.map((inski, index) => (
                    <li key={index} className="text-gray-300">{inski}</li>
                  ))}
                </ul>
              </CardContent>
            </Card>
            <Card className="bg-gray-800 text-white overflow-hidden transform transition-all hover:scale-105 hover:shadow-2xl">
              <div className="h-2 bg-gradient-to-r from-green-600 to-indigo-600"></div>
              <CardHeader>
                <CardTitle className="text-2xl font-bold">Framework & Libraries</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="list-disc list-inside">
            ...
            <Card className="bg-gray-800 text-white overflow-hidden transform transition-all hover:scale-105 hover:shadow-2xl">
              <div className="h-2 bg-gradient-to-r from-blue-600 to-pink-600"></div>
              <CardHeader>
                <CardTitle className="text-2xl font-bold">Other</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="list-disc list-inside">
                  {skills.other.map((ot, index) => (
                    <li key={index} className="text-gray-300">{ot}</li>
                  ))}
                </ul>
              </CardContent>
            </Card>
